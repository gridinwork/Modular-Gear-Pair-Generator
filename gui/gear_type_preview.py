"""Предпросмотр типа шестерни — изображения из assets/gear_types."""
...
GEAR_TYPE_IMAGE_FILES: dict[GearType, str] = {
    GearType.SPUR: "spur.svg",
    GearType.HELICAL: "helical.svg",
    GearType.DOUBLE_HELICAL: "double_helical.svg",
    GearType.INTERNAL_SPUR: "internal_spur.svg",
    GearType.INTERNAL_HELICAL: "internal_helical.svg",
    GearType.INTERNAL_DOUBLE_HELICAL: "internal_double_helical.svg",
}
...
class GearTypePreviewWidget(QWidget):
    ...
    def set_gear_type(self, gear_type: GearType) -> None:
        ...
        filename = GEAR_TYPE_IMAGE_FILES.get(gear_type, "spur.svg")
